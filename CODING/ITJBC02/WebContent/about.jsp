...
<h1 style="font-size: 30px;">CLOUD STORAGE</h1>
  <tr style="font-size: 30px;">
    ...
    <th style="text-align: center;">Previous Hash</th>
 <th style="text-align: center;">After Hash</th>
       ...
       con=Database.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM `itjbco2`.`fileupload` where useremail='"+email+"'");
       ...
       while(rs.next())
       {
    	...
    	String fileusername=  rs.getString(2); 
    	String type=  rs.getString(2); 
    	String filename=  rs.getString(10); 
    	  String filetype=rs.getString(11); 
