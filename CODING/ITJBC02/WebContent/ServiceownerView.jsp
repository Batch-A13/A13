    ...
    <th style="text-align: center;">FILESIZE</th>
     <th style="text-align: center;">MESSAGE</th>
      <th style="text-align: center;">STATUS</th>
       ...
       con=Database.create();
       PreparedStatement ps=con.prepareStatement("SELECT  f.filename,f.filesize,f.filecontent,f.useremail,o.file,o.omail,o.message,o.id FROM `itjbco2`.`fileupload` f , `itjbco2`.`ownerreq` o where f.filename=o.file");
     ...
     <td style="text-align: center;"><%=filename%></td>
      <td style="text-align: center;"><%= umail %></td>
       ...
       <td style="text-align: center;"><a href="AcceptOwner?id=<%=fid%> &&filename=<%=filename%> &&message=<%=message%> &&umail=<%=umail%>"><button class="btn btn-success" style="font-family: The Devil Net;">Accept</button></a></td>
       <td style="text-align: center;"><a href="Delete.jsp?"><button class="btn btn-danger" style="font-family: The Devil Net;">Delete</button></a></td>
     </tr>
