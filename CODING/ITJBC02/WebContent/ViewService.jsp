...
<h1 style = "font-size:30px;color:#c95802;"> BLOCK CHAIN </h1>
  <tr style="font-size: 30px;">
    <th style="text-align: center;">USERNAME</th>
    <th style="text-align: center;">FILENAME</th> 
    <th style="text-align: center;">FILETYPE</th>
     <th style="text-align: center;">FILESIZE</th>
      <th style="text-align: center;">FILE KEY</th>
          <th style="text-align: center;">CSP KEY</th>
       ...
       while(rs.next())
       {
    	...
    	String filename=  rs.getString(2); 
    	  ...
    	  String filekey=rs.getString(6);
    	  String cspkey=rs.getString(7);
       %>
