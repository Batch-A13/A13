		...
		<div class="main-w3l">
			...
			<div class="w3layouts-main">
				<h2><span>Login now</span></h2>
					...
					<div class="row">
				  <div style="border-top: 1px solid#888;color:red; padding-top:15px; font-size:85%" >
                                            Don't have an account! 
                                        <a href="UserRegister.jsp" onClick="$('#loginbox').hide(); $('#signupbox').show()" style="color:yellow">
                                            Sign Up Here
                                        </a>
