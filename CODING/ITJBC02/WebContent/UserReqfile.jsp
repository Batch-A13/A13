    ...
    <th style="text-align: center;">OWNERNAME</th>
     ...
     <th style="text-align: center;">PREHASH</th>
      <th style="text-align: center;">AFTERHASH</th>
       ...
       con=Database.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM `itjbco2`.`userrequest`");
     ...
     <td style="text-align: center;"><%=filename%></td>
       ...
       <td style="text-align: center;"><a href="AcceptThird?id=<%=id%> &&filename=<%=filename%> &&filekey=<%=filekey%>&&cspkey=<%=cspkey %>&&umail=<%=umail%>&&omail=<%=omail%>&&prehash=<%=prehash%>&&afterhash=<%=afterhash%>"><button class="btn btn-success" style="font-family: The Devil Net;">Accept</button></a></td>
